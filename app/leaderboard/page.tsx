// Move your existing app/page.tsx content here
// This is now at /leaderboard route
  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", padding: "0" }}>
      ...
      <div style={{ padding: "64px 32px 48px", maxWidth: "1100px", margin: "0 auto" }}>
        ...
        >
          Agent <span style={{ color: "var(--amber)" }}>Leaderboard</span>
        </h1>
        <p style={{ color: "var(--text-secondary)", fontSize: "15px", maxWidth: "480px", lineHeight: 1.6, fontFamily: "'Outfit', sans-serif" }}>
        ...
        <div style={{ display: "flex", gap: "32px", marginTop: "40px", flexWrap: "wrap" }}>
          {[
            ...
            <div key={label}>
              <div style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "24px", fontWeight: 500, color: "var(--text-primary)", letterSpacing: "-0.02em" }}>
                {value}
              </div>
              <div style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "11px", color: "var(--text-dim)", letterSpacing: "0.1em", textTransform: "uppercase", marginTop: "4px" }}>
                {label}
              </div>
            </div>
          ))}
